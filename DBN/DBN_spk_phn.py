...
class DatasetSentencesIterator(object):
    ...
    def __init__(self, x, y, phn_to_st, nframes=1):
        ...
        i = 0
        for i, s in enumerate(y[0] == phn_to_st['!ENTER[2]']):
    ...
    def __iter__(self):
        ...
        for start, end in self._start_end:
            ...
            if self._nframes > 1:
                ...
                yield self._stackpad(start, end), self._y[0][start:end], self._y[1][start:end]
            else:
                yield self._x[start:end], self._y[0][start:end], self._y[1][start:end]
