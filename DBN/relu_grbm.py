...
class GRBM(object):
    ...
    def free_energy(self, v_sample):
      ...
      hidden_term = T.nnet.softplus(wx_b)
    ...
    def propup(self, vis):
        ...
        return [pre_sigmoid_activation, (pre_sigmoid_activation + abs(pre_sigmoid_activation)) / 2.]
    ...
    def get_pseudo_likelihood_cost(self, updates):
        ...
        tmp = fe_xi_flip - fe_xi
        cost = T.mean(self.n_visible * (tmp + abs(tmp)) / 2.)
    ...
    def get_reconstruction_cost_MSE(self, updates, pre_sigmoid_nv):
        mse = T.sum(T.sqr(self.input - (pre_sigmoid_nv + abs(pre_sigmoid_nv)) / 2.), axis=1)
        return mse
    ...
    def get_reconstruction_cost(self, updates, pre_sigmoid_nv):
        ...
        cross_entropy = T.mean(
                T.sum(self.input * T.log(T.nnet.sigmoid(0, pre_sigmoid_nv)) +
                (1 - self.input) * T.log(1 - T.nnet.sigmoid(0, pre_sigmoid_nv)),
                      axis=1))
