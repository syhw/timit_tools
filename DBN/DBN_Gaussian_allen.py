...
BORROW = True # makes it faster on the GPU
...
output_file_name = 'dbn_1248_units_allen'
...
def test_DBN(finetune_lr=0.01, pretraining_epochs=20, # TODO 100+
             pretrain_lr=0.01, k=1, training_epochs=100, # TODO 100+
             dataset='/fhgfs/bootphon/scratch/gsynnaeve/allen/x_all_mfcc.npy', batch_size=10):
    """
